...
export default () => {
  ...
  <head>
    ...
    <% if (assets.version) { %><link rel="stylesheet" type="text/css" href="//cdn.auth0.com/extensions/auth0-tfs-deploy/assets/auth0-tfs-deploy.ui.<%= assets.version %>.css"><% } %>
  </head>
  <body class="a0-extension">
    ...
    <% if (assets.version) { %>
    <script type="text/javascript" src="//cdn.auth0.com/extensions/auth0-tfs-deploy/assets/auth0-tfs-deploy.ui.vendors.<%= assets.version %>.js"></script>
    <script type="text/javascript" src="//cdn.auth0.com/extensions/auth0-tfs-deploy/assets/auth0-tfs-deploy.ui.<%= assets.version %>.js"></script>
    <% } %>
  </body>
  </html>
  `;
